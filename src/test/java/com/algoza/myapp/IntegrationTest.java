...
import com.algoza.myapp.AlgozaApp;
import com.algoza.myapp.config.AsyncSyncConfiguration;
import com.algoza.myapp.config.EmbeddedSQL;
...
@SpringBootTest(classes = { AlgozaApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
