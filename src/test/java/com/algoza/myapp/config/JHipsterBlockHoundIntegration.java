package com.algoza.myapp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.algoza.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.algoza.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
